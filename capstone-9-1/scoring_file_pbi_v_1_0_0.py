...
data_sample = PandasParameterType(pd.DataFrame({"Age": pd.Series([0], dtype="int64"), "SystolicBP": pd.Series([0], dtype="int64"), "DiastolicBP": pd.Series([0], dtype="int64"), "BS": pd.Series([0.0], dtype="float64"), "BodyTemp": pd.Series([0], dtype="int64"), "HeartRate": pd.Series([0], dtype="int64")}))
